...
class SEOAnalysisService {
  constructor(config) {
    ...
    this.keywordResearchService =
      new keyword_research_service_1.KeywordResearchService({
        model: config.model,
        prisma: config.prisma,
    ...
    this.readabilityScoringService =
      new readability_scoring_service_1.ReadabilityScoringService({
        model: config.model,
        prisma: config.prisma,
        cacheResults: config.cacheResults,
        cacheTTL: config.cacheTTL,
