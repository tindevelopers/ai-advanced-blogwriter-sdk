...
async function validatePerformanceOptimizationServices() {
  ...
  try {
    ...
    const recommendationEngine = new OptimizationRecommendationEngine(prisma, 'mock-api-key');
    ...
    console.log(`✅ PerformanceOptimizationError created: ${customError.message}`);
