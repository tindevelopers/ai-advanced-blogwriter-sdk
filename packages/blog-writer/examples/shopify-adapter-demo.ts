...
async function basicShopifyExample() {
  ...
  try {
    ...
    const blogPost: BlogPost = {
      ...
      `,
      excerpt:
        'Discover the top 10 must-have products for Spring 2024, from fashion to home decor and tech accessories.',
      ...
      seoDescription:
        'Discover the latest spring trends and must-have products. Shop our curated collection of fashion, home, and tech items for the season.',
...
async function advancedShopifyExample() {
  ...
  try {
    ...
    const productBlogPost: BlogPost = {
      ...
      `,
      excerpt:
        'Discover how to style your summer look with our new collection. Get expert tips and shop our featured products.',
    ...
    const formattedContent =
      await shopifyAdapter.formatContent(productBlogPost);
...
async function multiPlatformWithShopify() {
  ...
  const blogPost: BlogPost = {
    ...
    `,
    excerpt:
      'Discover practical tips for sustainable living and shop our eco-friendly product collection.',
  ...
  try {
    ...
    const aggregatedAnalytics = await multiPublisher.getAggregatedAnalytics([
      'shopify',
    ]);
