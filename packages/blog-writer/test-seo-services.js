...
async function testSEOServicesImports() {
    ...
    try {
        ...
        const { DataForSEOService } = await Promise.resolve().then(() => __importStar(require('./src/core/dataforseo-service')));
        ...
        const { KeywordResearchService } = await Promise.resolve().then(() => __importStar(require('./src/core/keyword-research-service')));
        ...
        const { OnPageSEOService } = await Promise.resolve().then(() => __importStar(require('./src/core/onpage-seo-service')));
        ...
        const { MetaSchemaService } = await Promise.resolve().then(() => __importStar(require('./src/core/meta-schema-service')));
        ...
        const { ReadabilityScoringService } = await Promise.resolve().then(() => __importStar(require('./src/core/readability-scoring-service')));
        ...
        const { SEOAnalysisService } = await Promise.resolve().then(() => __importStar(require('./src/core/seo-analysis-service')));
        ...
        const types = await Promise.resolve().then(() => __importStar(require('./src/types/seo-engine')));
        console.log(`   ✅ SEO Engine Types imported (${Object.keys(types).length} exports)`);
